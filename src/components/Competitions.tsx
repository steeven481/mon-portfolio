...
import { Trophy, Calendar, MapPin, Users, Award, Target, Code2 } from 'lucide-react';
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <Badge 
                    variant="secondary" 
                    className={`shrink-0 ${
                      competition.rank.includes('1ère') ? 'bg-yellow-500/10 text-yellow-700 dark:text-yellow-400' :
